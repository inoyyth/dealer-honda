...
INSERT INTO `menus` VALUES ('35', '3', 'motor_terima', 'Import Penerimaan Motor', 'fa fa-circle', 'import-penerimaan-motor', '3', '2');
...
CREATE TABLE `penerimaan_motor` (
  ...
  `nosj` varchar(15) DEFAULT NULL,
  `tgl_sj` date DEFAULT NULL,
  `noso` varchar(15) DEFAULT NULL,
