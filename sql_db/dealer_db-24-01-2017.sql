...
INSERT INTO `menus` VALUES ('38', '2', 't_kwitansi', 'Kwitansi DP', 'fa fa-circle', 'kwitansi-dp-tambah', '2', '1');
...
CREATE TABLE `penerimaan_motor` (
  ...
  `m_status` enum('1','2','3') DEFAULT '1',
  `status_jual` enum('1','2','3') DEFAULT '1' COMMENT '1=belum terjual, 2=sudah terjual, 3=retur',
  `sys_create_user` int(11) DEFAULT NULL,
  `sys_update_user` int(11) DEFAULT NULL,
  `sys_delete_user` int(11) DEFAULT NULL,
  `sys_create_date` datetime DEFAULT NULL,
...
-- Records of t_pdi
-- ----------------------------
INSERT INTO `t_pdi` VALUES ('1', 'PDI-2017/I/000001', 'SO/MKA-2016/XII/000001', 'SJ-2017/I/000001', '2017-01-22', 'Yusuf', '1', '0000-00-00', '1', null, '1', '2017-01-04', '2017-01-22', null, '6', '6', null);
