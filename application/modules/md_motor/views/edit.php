        ...
        <div class="col-md-6">
            <div class="block-web">
                ...
                <div class="porlets-content">
                    ...
                    <div class="form-group">
                        <label>Varian</label>
                        <input type="text" name="varian" value="<?php echo $detail['varian'];?>" parsley-trigger="change" required placeholder="Isi Varian Motor" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Merk</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="harga_otr" value="<?php echo $detail['harga_otr'];?>" parsley-trigger="change" required placeholder="Isi Harga OTR" class="form-control mask" data-inputmask="'mask':'Rp. 99.999.999', 'greedy' : false, 'rightAlignNumerics' : false">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
        ...
        <div class="col-lg-6">
            <div class="block-web">
                ...
                <div class="porlets-content text-center">
                    <img id="image1" onerror="this.onerror=null;this.src='<?php echo base_url('assets/images/motor/icon.png');?>';" src="<?php echo (!empty($detail['nama_foto'])?base_url($detail['nama_foto']):base_url('assets/images/motor/icon.png'));?>" style="height: 300px;" alt="..." class="img-rounded img-responsive">
                    <input type="file" onchange="readURL(this);" class="form-control input-sm" name="foto" id="foto">
                    <input type="hidden" name="image_hidden" value="<?php echo $detail['nama_foto'];?>">
                </div>
            </div>
        </div>
    </form>
