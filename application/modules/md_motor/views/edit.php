        ...
        <div class="col-lg-6">
            <div class="block-web">
                ...
                <div class="porlets-content text-center">
                    <img id="image1" src="<?php echo (!empty($detail['nama_foto'])?base_url($detail['nama_foto']):base_url('assets/images/motor_icon.png'));?>" style="height: 300px;" alt="..." class="img-rounded img-responsive">
