            ...
            <div class="block-web">
                ...
                <div class="porlets-content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tgl_motor_keluar" parsley-trigger="change" required placeholder="Pilih Tanggal" class="form-control datepicker">
                    </div>
        ...
        <div class="col-md-6">
            <div class="block-web">
                <div class="porlets-content">
                    <div class="form-group">
                        <label>Kode PO</label>
                        <input type="text" name="kode_po_motor_keluar" parsley-trigger="change" required placeholder="Isi Kode PO" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Kode DO</label>
                        <input type="text" name="kode_do_motor_keluar" parsley-trigger="change" required placeholder="Isi Kode DO" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>PIC</label>
                        <input type="text" name="pic_motor_keluar" parsley-trigger="change" required placeholder="Isi PIC" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
                        <textarea name="keterangan_motor_keluar" parsley-trigger="change" required placeholder="Isi Keterangan" class="form-control"></textarea>
                    </div>
                </div>
            </div>
        </div>
