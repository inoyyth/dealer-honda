<div class="row">
    ...
    <div class="col-md-4">
        <div class="block-web">
            ...
            <div class="porlets-content">
                <img id="image1" src="<?php echo (!empty($detail['url_foto'])?base_url($detail['url_foto']):base_url('assets/images/aksesoris/icon.png'));?>" alt="..." class="img-circle img-responsive">
