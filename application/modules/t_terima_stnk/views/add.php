                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="remote">
                                ...
                                <div class="col-sm-9">
                                    <input type="hidden" name="t_stnk_id" id="t_stnk_id">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="birojasa_id" id="birojasa_id" parsley-trigger="change" required class="form-control">
                                        <option value="" selected="true" disabled="true">- Select Biro Jasa -</option>
                                        <?php foreach($birojasa as $kBirojasa=>$vBirojasa){ ?>
                                        <option value="<?php echo $vBirojasa['id'];?>"><?php echo $vBirojasa['nama_birojasa'];?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_tgl_stnk" id="t_terima_tgl_stnk" parsley-trigger="change" required placeholder="Tanggal Jadi STNK" class="form-control datepicker">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Tgl.Jadi BPKB</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_tgl_bpkb" id="t_terima_tgl_bpkb" parsley-trigger="change" required placeholder="Tanggal Jadi BPKB" class="form-control datepicker">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No.Polisi</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_no_polisi" id="t_terima_no_polisi" required parsley-trigger="change" placeholder="No.Polisi" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No.STNK</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_no_stnk" id="t_terima_no_stnk" required parsley-trigger="change" placeholder="No.STNK" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No.BPKB</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_no_bpkb" id="t_terima_no_bpkb" required parsley-trigger="change" placeholder="No.BPKB" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No.Bon BJ 1</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_no_bon_1" id="t_terima_no_bon_1" required parsley-trigger="change" placeholder="No.Bon Birojasa 1" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No.Bon BJ 2</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_no_bon_2" id="t_terima_no_bon_2" required parsley-trigger="change" placeholder="No.Bon Birojasa 2" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Biaya Tbh. 1</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_add_biaya_1" id="t_terima_add_biaya_1" required parsley-trigger="change" placeholder="Biaya Tambahan 1" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Biaya Tbh. 2</label>
                                <div class="col-sm-9">
                                    <input type="text" name="t_terima_add_biaya_2" id="t_terima_add_biaya_2" required parsley-trigger="change" placeholder="Biaya Tambahan 2" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Keterangan</label>
                                <div class="col-sm-9">
                                    <textarea name="t_terima_add_biaya_1_description" id="t_terima_add_biaya_1_description" required parsley-trigger="change" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
