...
<div id="printThis" style="padding: 10px;text-align: justify;">
    ...
    <div>
        ...
        <br>
        <p>
            Dengan ini menyatakan bahwa akan menyerahkan/bertanggung jawab atas STNK, BPKB dan Faktur 1 (satu) 
            unit sepeda motor : 
        </p>
        <table style="margin-left: 40px;">
            <tr>
        ...
        <br>
        <p>
            BPKB tersebut di atas akan kami serahkan kepada <b>PT FEDERAL INTERNATIONAL FINANCE</b> 
            dalam waktu kurang lebih 6 (enam) bulan dari tanggal penyerahan surat pernyataan ini.
        </p>
        <p>
            Demikian surat pernyataan ini dibuat agar dipergunakan sebagaimana mestinya. Atas 
