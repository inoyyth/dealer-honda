    ...
    <div style="width:94%;">
        ...
        <div>
            ...
            <p style="text-align: justify;">
                Dalam hal ini bertindak selaku kuasa hukum <b><?php echo ucwords($detail_owner['company_name']); ?></b> dan dengan demikian sah mewakili dan bertindak untuk dan atas nama <b><?php echo ucwords($detail_owner['company_name']); ?></b>
            </p>
            <p>
                Dengan ini menerangkan dan menyatakan hal-hal sebagai berikut :
            </p>
            <p style="text-align: justify;">
                Bahwa konsumen (sebagai didefinisikan dibawah ini) telah membeli kendaraan dari dealer dengan data-data sebagai berikut : 
            </p>
            <table style="margin-left: 40px;">
                <tr>
                    <td>Nama</td>
            ...
            <ol type="I">
                ...
                <li style="text-align: justify;">
                    Memberi kuasa dengan hak substitusi kepada PT.Wahana Ottomitra Multiartha Tbk,("WOM Finance") untuk mengkompensasikan (menjumpakan) dengan tagihan-tagihan (Insentif Dealer) terhadap WOM Finance, dengan demikian tidak diperlukan lagi kuasa khusus tersendiri agar WOM Finance dapat melaksanakan haknya berdasarkan Covernote ini; dan
                </li>
                <li style="text-align: justify;">
