 ...
 */
    ...
    $data = $this->db->query('select a.*,f.nama_customer,b.nomsn,b.tanggal as tanggalbeli,b.warna_motor,f.alamat_customer,f.telepon_customer,b.harga_otr,c.fee,c.diskon,c.cara_pembelian,d.tahun as tahunmotor,d.norangka,d.tipe_motor from t_pdi a 
