            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-sm-9">
                        <button name="submit" id="apply" onclick="return confirm('are u sure to cancel all transaction?');" class="btn btn-primary">Apply</button>
                        </div>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        var bestPictures = new Bloodhound({
            ...
            remote: {
              url: '<?php echo base_url('t_void/t_void/getSO?query=%QUERY');?>',
              wildcard: '%QUERY'
            }
        });
