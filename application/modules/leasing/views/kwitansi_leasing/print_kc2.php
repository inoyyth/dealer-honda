...
<body>
    ...
    <table style="width: 100%;" style="font-size: 10px;" cellspacing="0" cellpadding="3">
        <tr>
            ...
            <td style="font-size:15px;width: 75%;border-top:2px solid;border-right:2px solid;">  <?php echo $noKwitansi; ?><b>C2</b> </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="font-size:15px;width: 75%;border-right:2px solid;"> <?php echo terbilang($list->subsidi2); ?></td>
        </tr>  
        ...
        <tr>
            ...
            <td style="font-size:15px;width: 75%;border-right:2px solid;border-bottom:2px solid;">Rp. <?php echo formatrp($list->subsidi2); ?></td>
        </tr>
    </table>
