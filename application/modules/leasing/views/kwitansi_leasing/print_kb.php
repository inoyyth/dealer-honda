...
<body>
    ...
    <table style="width: 100%;" style="font-size: 10px;" cellspacing="0" cellpadding="3">
        <tr>
            ...
            <td style="font-size:15px;width: 75%;border-top:2px solid;border-right:2px solid;">  <?php echo "KWT-" . $kwt_explode[1] . "-" . $kwt_explode[2] . "-" . $kwt_explode[3]; ?> <b> B</b></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="font-size:15px;width: 75%;border-right:2px solid;"> <?php echo terbilang($list->dp_system);  ?></td>
        </tr>  
         ...
         <tr>
            ...
            <td style="font-size:15px;width: 75%;border-right:2px solid;"> 
                KWITANSI DP SYSTEM  TIPE <?php echo $list->tipe;  ?> <br>
                SECARA <u> KREDIT </u>
            </td>
        </tr>  
