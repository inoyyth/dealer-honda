    ...
    <div class="col-lg-12">
        <section class="panel default blue_title h4">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-6 pull-left">Kwitansi Fee
                    </div>
                    <div class="col-md-6 pull-right text-right">
                         <a href="<?php echo base_url('kwitansi-fee-tambah');?>" class="btn btn-default btn-sm"><i class="fa fa-plus"></i> Tambah </a>
                    </div> 
                </div>
            </div>
                            ...
                            if (count($data) < 1) {
                                ...
                                foreach ($data as $k => $v) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "Rp.".formatrp($v['fee']); ?></td>
                                         
                                        <td class="text-center">
 
                                            <a href="<?php echo base_url('kwitansi-fee-detail/'.$v['id']);?>" class="btn btn-default btn-sm"><i class="fa fa-info"></i> Detail</a>
                                            <a href="<?php echo base_url('kwitansi-fee-pdf/'.$v['id']);?>" target="_blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a>
                                        </td>
                                    </tr>
    <?php }
} ?>
                        ...
                        <tfoot>
                        <form id="form1" method="post" action="<?php echo base_url('kwitansi-fee'); ?>">
                            <tr>
                                <td>#</td>
                                <td>
                                ...
                                <td>
                                    <input class="form-control input-sm" name="fee" value="<?php echo (isset($sr_data['fee']) ? $sr_data['fee'] : ""); ?>" style="width: 100%;" type="text" onkeyup="javascript:if (event.keyCode == 13) {
                                                submit_search('form1');
                                            } else {
                                                return false;
                                            }
