...
<table style="font-size: 12px;" cellpadding="4">
    ...
    <tr>
        <td>Uang Sejumlah</td>
        <td colspan="2" style="font-weight: bold;">: <?php echo ucwords(terbilang($parsing->fee)); ?></td>
    </tr>
    <tr>
        <td></td>
        <td colspan="3"></td>
    ...
    <tr>
        <td>Jumlah </td>
        <td style="width: 200px;font-weight: bold;">: Rp. <?php echo formatrp($parsing->fee);?>,00</td>
        <td style="width: 200px;">Secara <?php echo $parsing->cara_pembelian . '-'. $parsing->leasing. ' - '. $parsing->nama_customer;?> </td>
