            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-6 pull-right text-right">
                        ...
                        <?php echo $this->button_lib->render(array('anchor' => 'prt', 'url' => 'pdi-pdf/?template=table_pdf&name=t_pdi', 'text' => 'Print')); ?>
                        <?php echo $this->button_lib->render(array('anchor' => 'prt', 'url' => 'pdi-excel/?template=table_excel&name=t_pdi', 'text' => 'Excel')); ?>
                    </div> 
                </div>
            </div>
