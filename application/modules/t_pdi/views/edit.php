                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="tgl_pdi" id="tgl_pdi" parsley-trigger="change" value="<?php echo $detail['tgl_pdi']; ?>"   placeholder="Tanggal PDI" class="form-control datepicker">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="pic" id="pic" parsley-trigger="change" value="<?php echo $detail['pic'];?>" placeholder="Input PIC" class="form-control">
                            </div>
                        </div>
                    </div>
