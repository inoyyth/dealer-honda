			...
			<div class="panel-heading">
				<div class="row">
					...
					<div class="col-md-6 pull-right text-right">
						<a href="<?php echo base_url();?>master-karyawan-tambah" class="btn btn-primary btn-sm"><i class="fa fa-plus-square"></i> Tambah</a> 
						<a href="<?php echo base_url('master-karyawan-pdf/?template=table_pdf&name=master_karyawan');?>" target="__blank" class="btn btn-default btn-sm"><i class="fa fa-print"></i> Print</a>
						<a href="<?php echo base_url('master-karyawan-excel/?template=table_excel&name=master_karyawan');?>" target="__blank" class="btn btn-default btn-sm"><i class="fa fa-file-excel-o"></i> Excel</a>
					</div> 
				</div>
			</div>
					...
					<table class="table table-bordered">
						...
						<?php 
							...
							<tr>
								...
								<td class="text-center">
									<a class="btn btn-sm btn-warning" href="<?php echo base_url("master-karyawan-edit-".$v['id']);?>">Edit</a> 
									<a class="btn btn-sm btn-danger" href="<?php echo base_url("master-karyawan-delete-".$v['id']);?>" onclick="return confirm('Yakin Hapus Data ?');">Delete</a> 
								</td>
							</tr>
						<?php }} ?>
						</tbody>
						<tfoot>
							...
							<tr>
								<td>#</td>
								<td>
									<input class="form-control input-sm" name="kd_karyawan" class="form-control" value="<?php echo (isset($sr_data['kd_karyawan'])?$sr_data['kd_karyawan']:"");?>" type="text" onkeyup="javascript:if(event.keyCode == 13){submit_search('form1');}else{return false;};"/>
								</td>
								<td>
									<input class="form-control input-sm" name="karyawan" value="<?php echo (isset($sr_data['karyawan'])?$sr_data['karyawan']:"");?>" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){submit_search('form1');}else{return false;};"/>
								</td>
                                <td>
                                ...
                                <td>
									<input class="form-control input-sm datepicker" name="tgl_masuk" value="<?php echo (isset($sr_data['tgl_masuk'])?$sr_data['tgl_masuk']:"");?>" style="width: 100%;" type="text" onkeyup="javascript:if(event.keyCode == 13){submit_search('form1');}else{return false;};"/>
								</td>
								<td>
