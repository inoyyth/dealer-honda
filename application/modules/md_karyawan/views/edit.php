<div class="row">
    ...
    <div class="col-md-4">
        <div class="block-web">
            ...
            <div class="porlets-content">
                <img id="image1" onerror="this.onerror=null;this.src='<?php echo base_url('assets/images/karyawan/icon.png');?>';" src="<?php echo (!empty($detail['foto'])?base_url($detail['foto']):base_url('assets/images/karyawan/icon.png'));?>" alt="..." class="img-circle img-responsive">
