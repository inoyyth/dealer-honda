<div class="row">
    ...
    <div class="col-md-4">
        <div class="block-web">
            ...
            <div class="porlets-content">
                <img id="image1" src="<?php echo (!empty($detail['foto'])?base_url('assets/images/karyawan/'.$detail['foto']):base_url('assets/images/user_icon.png'));?>" alt="..." class="img-circle img-responsive">
