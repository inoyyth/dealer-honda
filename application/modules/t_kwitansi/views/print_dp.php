...
<body>
    ...
    <table style="width: 100%;" style="font-size:12px;" cellspacing="0" cellpadding="1">
        <tr>
            ...
            <td style="font-size:12px;width: 75%;border-top:2px solid;border-right:2px solid;"> <?php echo $dp['nokwitansi']; ?></td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;" style="font-size: 10px;" cellspacing="0" cellpadding="1">
        <tr>
            ...
            <td style="font-size:12px;width: 75%;border-top:2px solid;border-right:2px solid;"> <?php echo $detail_customer['nama_customer'];?></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="font-size:12px;width: 75%;border-right:2px solid;"> <?php echo ucwords(terbilang($total_kwitansi)); ?></td>
        </tr>  
        <tr>
        ...
        <tr>
            ...
            <td style="font-size:12px;width: 75%;border-right:2px solid;"> <?php echo formatrp($total_kwitansi); ?>,00</td>
        </tr>
        <tr>
    ...
    <center>
        <table style="font-size: 15px;" cellpadding="1">
            <tr>
                <td style="font-size:12px;width: 30%;text-align: center;">Kasir</td>
                <td style="font-size:12px;width: 30%;text-align: center;">Mengetahui</td>
                <td style="font-size:12px;width: 30%;text-align: center;">Penerima</td>
            </tr>
            <tr>
                <td colspan="3"></td>
            </tr>
