...
class Aksesoris_terima extends MX_Controller {
    ...
    public function __construct() {
        ...
        //set breadcrumb
        $this->breadcrumbs->push('Input Aksesoris', '/aksesoris-terima');
    }

    public function index() {
        $data_session = $this->__getSession();
        $config['base_url'] = base_url() . 'aksesoris-terima-page';
        ...
        $data['data'] = $this->m_aksesoris_terima->getdata($this->table, $limit, $config['per_page'], $like = $data_session, $where = array('m_status!=' => '3'));
    ...
    public function add() {
        $this->breadcrumbs->push('Add', '/aksesoris-terima-tambah');
    ...
    public function edit($id) {
        $this->breadcrumbs->push('Edit', '/aksesoris-terima-edit');
