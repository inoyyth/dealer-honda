    ...
    <div class="col-lg-12">
        <section class="panel default blue_title h4">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-6 pull-left">Input Aksesoris
                    </div>
                    <div class="col-md-6 pull-right text-right">
                        <?php echo $this->button_lib->render(array('anchor' => 'add', 'url' => 'input-penerimaan-aksesoris-tambah', 'text' => 'Tambah')); ?>
                        <?php echo $this->button_lib->render(array('anchor' => 'prt', 'url' => 'input-penerimaan-aksesoris-pdf/?template=table_pdf&name=master_gudang', 'text' => 'Print')); ?>
                        <?php echo $this->button_lib->render(array('anchor' => 'prt', 'url' => 'input-penerimaan-aksesoris-excel/?template=table_excel&name=master_gudang', 'text' => 'Excel')); ?>
                    </div> 
                </div>
            </div>
