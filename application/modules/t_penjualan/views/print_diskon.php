...
<table style="font-size: 12px;" cellpadding="4">
    ...
    <tr>
        <td>Uang Sejumlah</td>
        <td colspan="2" style="font-weight: bold;">: <?php echo ucwords(terbilang($detail_harga['diskon'])); ?></td>
    </tr>
    <tr>
        <td></td>
        <td colspan="3"></td>
    ...
    <tr>
        ...
        <td colspan="2" style="font-weight: bold;">: Diskon </td>
    </tr>
    <tr>
        <td>Detail Motor</td>
        <td colspan="3">: 
    ...
    <tr>
        <td>Jumlah </td>
        <td style="width: 200px;font-weight: bold;">: Rp. <?php echo formatrp($detail_harga['diskon']);?>,00</td>
