            ...
            <div class="block-web">
                ...
                <div class="porlets-content">
                    <div class="form-group">
                        <input type="hidden" name="id" value="<?php echo $detail_penjualan['id'];?>">
                        <label class="col-sm-3 control-label">No Sales Order</label>
                        <div class="col-sm-9">
                            <input type="text" name="noso" id="noso" parsley-trigger="change"  readonly="true" value="<?php echo $detail_penjualan['noso']; ?>" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Tanggal</label>
                        <div class="col-sm-9">
                            <input type="text" name="tanggal" id="tanggal" value="<?php echo $detail_penjualan['tanggal'];?>" parsley-trigger="change" required placeholder="Pilih Tanggal" class="form-control datepicker">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="norangka" id="norangka" value="<?php echo $detail_penerimaan_motor['norangka'];?>" parsley-trigger="change" readonly="true" placeholder="No Rangka" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Nama Motor</label>
                        <div class="col-sm-9">
                            <input type="text" name="nama_motor" value="<?php echo $detail_motor['nama_motor'];?>" id="nama_motor" parsley-trigger="change" readonly="true" placeholder="Nama Motor" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Warna</label>
                        <div class="col-sm-9">
                            <input type="text" name="warna" value="<?php echo $detail_penerimaan_motor['warna'];?>" id="warna" parsley-trigger="change" readonly="true" placeholder="Warna" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">Tahun</label>
                        <div class="col-sm-9">
                            <input type="text" name="tahun" id="tahun" value="<?php echo $detail_penerimaan_motor['tahun'];?>" parsley-trigger="change" readonly="true" placeholder="Tahun" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
